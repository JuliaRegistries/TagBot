...
**Step 1:** Generate a GitHub personal access token. To do so, go to <https://github.com/settings/tokens/new>, name it anything you wish, and select either `repo` or `public_repo`, depending on whether or not you will use tagbot with private repositories. Save this somewhere secret, like a password.
