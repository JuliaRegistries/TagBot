...
The canonical example workflow is kept in this repository at `example.yml`; to use it, copy its contents into `.github/workflows/TagBot.yml` or use it as a template and edit the inputs you need.
