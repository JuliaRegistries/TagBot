...
Your repository should have received a pull request doing this for you, but if you did not receive this pull request, then see [here](https://github.com/JuliaRegistries/TagBot#setup) for instructions.
For more information about this deprecation, please see [this Discourse post](TODO DISCOURSE LINK).
`
